  ...
  return (
    ...
    >
      <div className="flex-1 flex flex-col items-center justify-center px-7 text-center">
        ...
        <div className="rounded-2xl px-4 py-4 mb-4 bg-white/10" style={{ backdropFilter: "blur(8px)" }}>
        ...
        <div className="rounded-2xl px-4 py-4 mb-4 bg-white/10" style={{ backdropFilter: "blur(8px)" }}>
          <div className="text-[11px] text-white/70 mb-2">Explanation</div>
          <div className="text-[13px] text-white/90">{result.explanation}</div>
        </div>
      </div>
...
export default function NeuroSyncGuard() {
  ...
  return (
    <div className="relative min-h-screen w-full flex items-center justify-center" style={{ background: "#E7EAF0" }}>
      <div
